...
let thirdTestScore = 99
let finalProduct = "\(student) scored very poorly on his first math test getting a score of \(firstTestScore). But as the year progresses \(student) starts improving getting \(secondTestScore) on his second test and \(thirdTestScore) on his third one."
