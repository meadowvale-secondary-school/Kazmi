...
let totalrevenue = ticketPrice * ticketsSold
let totalcost = printingCosts + advertising
let jackpots = totalrevenue / 2
let earning = totalrevenue - jackpots - totalcost
let yourmoney = earning / 10
let histake = earning - yourmoney
